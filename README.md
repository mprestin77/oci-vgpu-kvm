...
In my OCI tenancy I am running DLS version 2.0 license server. You can download it from Nvidia Licensing Portal if you go to Software Downloads, Addition Software and select "DLS 2.0 for Linux KVM". Unzip the file and and upload DLS QCOW2 file to OCI Object Storage. After that you can import it to OCI as a Paravirtual custom image and create a VM from it. Alternatively you can run DLS appliance as one of VMs in KVM environment. For details how to obtain and register Nvidia vGPU license please, refer to 
